      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden">
          <div className="flex items-center justify-center gap-0">
            <h1 className="text-[3rem] sm:text-[4rem] md:text-[6rem] lg:text-[8rem] font-black tracking-tighter opacity-40 select-none uppercase leading-none text-glow mr-2">
              HI I'M
            </h1>
            <div className="w-80 md:w-96 lg:w-[28rem]"></div>
            <h1 className="text-[3rem] sm:text-[4rem] md:text-[6rem] lg:text-[8rem] font-black tracking-tighter opacity-40 select-none uppercase leading-none text-glow ml-2">
              AFAAN
            </h1>
          </div>
        </div>
